...
#creamos el mapa lleno de paredes
    mapa_laberinto = []
...
#aleatoriamente se pone un punto de inicio y a partir de ese punto se llenan los espacios
...
#aleatoriamente se ubica una ficha en el mapa
    ficha_fila = random.randrange(numero_filas)
    ficha_columnas = random.randrange(numero_columnas)
    mapa_laberinto[fila_posicion_actual][columna_posicion_actual] = 'T'
